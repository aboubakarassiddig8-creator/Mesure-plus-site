...
(function () {
  ...
  var FR = {
    ...
    apkMeta:'Fichier APK · 22 Mo · Android 6 ou plus récent',
    reassure:'Gratuit jusqu’à 10 clients • Fonctionne hors-ligne • Sans carte bancaire',
    ...
    freeFeatures:['10 clients','Toutes les fonctions','Fonctionne hors-ligne','Facture WhatsApp'], freeCta:'Télécharger',
    unlName:'Illimité', unlPrice:'2 000 F', unlPeriod:'/mois', unlAlt:'ou 20 000 F/an', unlBadge:'2 mois offerts',
    ...
    faq2q:'Comment je paie l’abonnement ?', faq2a:'Par Mobile Money ou Orange Money, directement depuis l’appli. 2 000 F par mois ou 20 000 F par an.',
  ...
  var EN = {
    ...
    apkMeta:'APK file · 22 MB · Android 6 or newer',
    reassure:'Free up to 10 clients • Works offline • No credit card',
    ...
    freeFeatures:['10 clients','All features','Works offline','WhatsApp invoice'], freeCta:'Download',
    unlName:'Unlimited', unlPrice:'2,000 F', unlPeriod:'/month', unlAlt:'or 20,000 F/year', unlBadge:'2 months free',
    ...
    faq2q:'How do I pay for the subscription?', faq2a:'By Mobile Money or Orange Money, directly from the app. 2,000 F per month or 20,000 F per year.',
